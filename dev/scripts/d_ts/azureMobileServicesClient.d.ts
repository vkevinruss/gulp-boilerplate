...
declare module Microsoft.WindowsAzure {
    ...
    // MobileServiceClient object based on Microsoft Azure documentation: 
    ...
    interface MobileServiceClient {
        ...
        withFilter(serviceFilter: (request: any, next: (request: any, callback: (error:any, response: any) => void ) => void, 
            callback: (error: any, response: any) => void ) => void ) : MobileServiceClient;
    }
    
    // User object based on Microsoft Azure documentation: 
    // http://msdn.microsoft.com/en-us/library/windowsazure/jj554220.aspx
    interface User {
    ...
    // MobileServiceTable object based on Microsoft Azure documentation: 
    // http://msdn.microsoft.com/en-us/library/windowsazure/jj554239.aspx
    ...
    // Interface to describe Query object fluent creation based on Microsoft Azure documentation: 
