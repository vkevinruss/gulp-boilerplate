...
interface HammerStatic {
    (element: any, options?: HammerOptions): void;
...
declare class HammerInstance {
    ...
    get(gesture: string): HammerGesture;
    ...
    trigger(gesture: string, eventData: HammerEvent): HammerInstance;
}

interface HammerGesture
{
    set(options: HammerGestureOptions);   
}

interface HammerGestureOptions
{
    enable: boolean;   
}
